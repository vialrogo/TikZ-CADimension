...
{%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  Start the body of Command  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \IfBooleanTF #1 {% With star
    ...
    \if #8a % Angular dimension
      ...
      \def\DeltaA{300mm/#3} % This fix always 5,2mm for the line
      \draw[Dim,<-] (@4) arc (\Angle:\Angle+\DeltaA:#3);
      \draw[Dim,<-] (@5) arc (180-\Angle:180-\Angle-\DeltaA:#3);
    ...
    \if #8a % Angular dimension
      \pgfmathanglebetweenpoints{\pgfpointanchor{@3}{center}}{\pgfpointanchor{@4}{center}}
      \let\Angle\pgfmathresult
      \draw[Dim, <->] (@4) to[out=\Angle-90, in=-\Angle-90]  node[Dim,Node] {#7\strut} (@5);
