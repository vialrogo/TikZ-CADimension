...
{%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  Start the body of Command  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \if #2o % If point isn't specified
    \if #8a % Angular dimension
      \coordinate (@6) at ($(@3)!#3!($0.5*(@4) + 0.5*(@5)$)$);

    \else\if #8r % Radial dimension
      \IfBooleanTF #1 {% With star
        \coordinate (@6) at ($(@5)!-10mm!(@4)$);
      }{% Without star
        \coordinate (@6) at ($0.5*(@4) + 0.5*(@5)$);
      }
  ...
  \IfBooleanTF #1 {% With star
    ...
    \if #8a % Angular dimension
      ...
      \node[Dim,Node] at (@6) {#7\strut};

    \else\if #8r % Radial dimension
      \coordinate (LAB) ato ($(@6) + (#3,0)$);
      \draw[Dim, <-] (@5) -- (@6) -- (LAB) node[Dim,Node] at (LAB) {#7\strut};
    ...
    \else\if #8r % Radial dimension
      \draw[Dim, ->] (@4) -- (@5) node[Dim,Node] at (@6) {#7\strut};
